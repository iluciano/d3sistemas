$(document).ready(function(){
	...
	$('.toggle-tabs').on('shown.bs.tab', function (e) {
	  ...
	  setTimeout(function(){
		...
		if($.fn.waypoint){
			$('#skills').waypoint(initCharts,{offset:'80%'});
		}else{
			initCharts();
		}
	/*============================================
	...
	if(reg.test(window.location.hash)){
		...
		Tweets
		==============================================*/
		$('#twitter-slider').html('<p class="tweet">Veja as novidades diretamente no Twitter.</p>');
	...
	/*============================================
		...
		==============================================*/
		function initScrollimations(){
			$('html').addClass('animations-enabled');
